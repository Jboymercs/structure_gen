...
public class WorldGenRedCrystals extends WorldGenerator {
    @Override
    ...
    protected void generateCrystalSpikes(World world, Random random, BlockPos pos) {
            ...
            for (int y = 0; y <= maxHeight; y++) {
                ...
                if(y != maxHeight) {
                    world.setBlockState(buildPos, ModBlocks.RED_CRYSTAL.getDefaultState());
                } else {
                    if (random.nextInt(2) == 0) {
                        world.setBlockState(buildPos, ModBlocks.RED_CRYSTAL_TOP.getDefaultState());
                    }
                }
            }
            //Set Side 1
